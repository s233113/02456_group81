...
from embeddings_try import preprocess_and_embed#(???)
...
class MambaFinetune(pl.LightningModule):
    ...
    def __init__(
        self,
        pretrained_model: MambaPretrain,# change with our data ???
        ...
        #    type_vocab_size=self.type_vocab_size,
         #   max_num_visits=self.max_num_visits,
           # time_embeddings_size=self.time_embeddings_size,
            ...
            #hidden_dropout_prob=self.dropout_prob,
        #)
        self.embeddings = preprocess_and_embed(self.pretrained_model,)
