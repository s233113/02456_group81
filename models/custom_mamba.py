...
early_stopping = EarlyStopping(patience=10, verbose=True, path="best_model_ayer.pt")
...
if __name__ == "__main__":
    ...
    print("Mamba sin hiperparametros")
    ...
    #Load best model
    model.load_state_dict(torch.load("best_model_ayer.pt"))
    # Test evaluation
