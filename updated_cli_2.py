...
@click.option(
    "--model_type", default="transformer", help="model_type (transformer, seft, grud, ipnets, mamba)"
)
...
@click.option("--seft_phi_dropout", default=0.0)
...
@click.option("--seft_rho_dropout", default=0.0)
...
@click.option("--vocab_size", default=9, help="Vocabulary size for the Mamba model")
def core_function(
    output_path,
    base_path,
    model_type,
    ...
    **kwargs,
    ...
    for split_index in range(1, 6):
        ...
        # Transformer or SEFT-specific settings
